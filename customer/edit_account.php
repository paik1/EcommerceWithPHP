<?php 
                        ...
                        $image = $row_customer['customer_photo'];
                ...
                <form method="post" enctype="multipart/form-data">
                    <table align="center" width="750">
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="c_address" value="<?php echo $address; ?>" ></textarea></td>
                        </tr>
...
<?php
    if(isset($_POST['update'])){
        ...
        $update_c = "update customers set customer_name='$c_name', customer_email='$c_email', customer_pass='$c_pass', customer_country='$c_country', customer_city='$c_city', customer_contact='$c_contact', customer_address='$c_address', customer_photo='$c_image' where customer_id='$customer_id'";
